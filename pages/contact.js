...
const useStyles = createStyles((theme) => ({
    generalContainer: {
        minHeight: `calc(100vh - ${theme.spacing.xl} * 2)`, // Adjust the spacing as needed
        display: 'flex',
        alignItems: 'center',
...
/* Set the Global User Context to Contact Component */
export default function ContactWithContext() {
    return (
        <>
            <NavBar />
            <UserProvider>
